...
<div class="article_list_search">
    <form name="search_form" action="index.php?m=admin&a=articleList_p&id=1" method="post" onsubmit="">
        <input title="search_key" name="post_search_key" class="search_key" placeholder="search key" type="text">
        <input type="submit" class="submit_search_key" value="搜索">
    </form>
</div>
<div class="article_list_box">
    ...
    <div class="page_number_list">
        ...
        if ($total_pages == 1 || $total_pages == 0) {
            echo "<a class='page_number_1' href='index.php?m=admin&a=articleList_p&id=1&key={$search_key}'>1</a>";
        } else {
            if ($current_page != 1) {
